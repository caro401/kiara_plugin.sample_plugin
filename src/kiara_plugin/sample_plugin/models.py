...
"""This module contains the metadata (and other) models that are used in the ``kiara_plugin.sample_plugin`` package.
...
Metadata models must be a sub-class of kiara.metadata.MetadataModel. Other models usually
